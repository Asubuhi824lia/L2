...
class CardHandlers {    
    ...
    setBtnHandler(card) {
        ...
        card.querySelector('.delBtn')
            .addEventListener('click', (e) => this._delBtnHandler(e))
        card.querySelector('.editBtn')
            .addEventListener('click', (e) => this._editBtnHandler(e))
    ...
    _editBtnHandler(e) {
        ...
        tasksElems.reverse().forEach((card,id_task)=>{
            ...
            if(curCard == card) 
            {
                ...
                while(newDeadline && !Datetime.checkDatetime(newDeadline)) {
                ...
                if(newDeadline && newDeadline!='' && Datetime.isDatetimeValid(newDeadline)) {
                    curCard.querySelector('.task-dates span:last-child strong').textContent = newDeadline.trim()
                    taskList.changeTaskField(id_task,"deadline",newDeadline.trim())
                }
                ...
                const deadline = (newDeadline == null || newDeadline==='') 
                    ...
                    : ((Datetime.isDatetimeValid(newDeadline)) ? card.querySelector('.task-dates span:last-child strong').textContent : newDeadline)
